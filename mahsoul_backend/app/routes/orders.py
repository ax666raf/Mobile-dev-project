...
def place_order():
    ...
    try:
        ...
        # After order is created successfully, create notifications for each farmer
        ...
        from app.routes.notification import create_order_notification
        for farmer_id in farmer_ids:
            create_order_notification(order.id, farmer_id)
