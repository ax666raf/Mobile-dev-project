                        ...
                        listener: (context, state) {
                          if (state is AuthAuthenticated) {
                            ...
                            if (state.userType == 'farmer') {
                              ...
                              // If somehow a customer logged in from farmer login, go to customer home
                        ...
                        builder: (context, setState) {
                          ...
                          return MouseRegion(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                // Navigate to sign up page with farmer type
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SignUpScreen(userType: 'farmer'),
                                  ),
                                );
                              },
                              child: Text(
