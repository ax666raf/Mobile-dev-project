              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    obscureText: true,
                    validator: (v) => v != _password ? l10n.passwordMismatch : null,
                    decoration: InputDecoration(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Checkbox(
                          ...
                          onChanged: (value) {
                            setState(() => _subscribeToUpdates = value ?? false);
                          },
                          activeColor: const Color(0xFF4CAF50),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(4),
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            setState(() => _subscribeToUpdates = !_subscribeToUpdates);
                          },
                          child: Text(
                        ...
                        child: MyButton(
                          ...
                          onPressed: isLoading ? null : () {
                            if (_formKey.currentState!.validate()) {
                              // Determine user type
                              final userType = widget.userType ?? 'customer';
                              ...
                              context.read<AuthCubit>().signup(
                                ...
                                userType: userType,
                                fullName: _fullName,
                                phoneNumber: null, // Can be added later if needed
                              );
                            }
                          },
                        ),
