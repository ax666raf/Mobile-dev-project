...
class _ProductPageState extends State<ProductPage> {
  ...
  Future<void> _loadProductData() async {
    ...
    if (product != null) {
      setState(() {
        ...
        availableWeights = weights
            .where((w) {
              ...
              return weightData['is_available'] == true ||
                  weightData['is_available'] == 1;
            })
      ...
      // Load reviews
      final productReviews = await productCubit.getProductReviews(
        widget.productId,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final isOrganic =
        product['is_organic'] == 1 || product['is_organic'] == true;
    final storageInstructions =
        product['storage_instructions'] as String? ?? '';
    // Calculate price based on selected weight
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ProductInfoCard(
                        ...
                        text:
                            '${rating.toStringAsFixed(1)} ± ${(rating * 0.1).toStringAsFixed(2)}',
                      ),
                      SizedBox(width: 8),
                      ProductInfoCard(
                        svgPath: 'lib/assets/second-svg.svg',
                        text: selectedWeight.isNotEmpty
                            ? selectedWeight
                            : l10n.nA,
                      ),
                      SizedBox(width: 8),
                          ...
                          try {
                            await cartCubit.addToCart(
                              ...
                              selectedWeight.isNotEmpty
                                  ? selectedWeight
                                  : '1kg', // Default weight if none available
                              1, // Quantity
                            );
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  '${l10n.failedToAddToCart}: ${e.toString()}',
                                ),
                  ...
                  ProductDetailsCard(
                    ...
                    harvestDate: harvestSeason.isNotEmpty
                        ? harvestSeason
                        : l10n.nA,
                    isOrganic: isOrganic,
                    storage: storageInstructions.isNotEmpty
                        ? storageInstructions
                        : l10n.nA,
                  ),
