...
class _MahsoulOrderScreenState extends State<MahsoulOrderScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...List.generate(cartItems.length, (index) {
                    ...
                    final productName =
                        product?['name'] as String? ?? l10n.unknownProduct;
                    // Try to get farm name from product's farmer data, or use a default
                    final farmerData =
                        product?['farmer'] as Map<String, dynamic>?;
                    final farmName =
                        farmerData?['farm_name'] as String? ??
                    ...
                    final selectedWeight =
                        item['selected_weight'] as String? ?? '';
                    final subtotal =
                    ...
                    return Padding(
                      ...
                      child: CartProductCard(
                        ...
                        farm: farmName,
                        price:
                            subtotal, // Use subtotal (unit_price * quantity) for display
                  ...
                  OrderSummaryCard(subtotal: total, total: total),
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      return BlocProvider(
        create: (context) =>
            CartCubit(DependencyInjection.cartRepository, widget.customerId)
              ..loadCart(),
