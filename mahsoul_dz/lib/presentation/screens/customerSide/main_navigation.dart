...
import 'package:mahsoul_dz/presentation/screens/customerSide/profile_page.dart';
        ...
        return BlocBuilder<AuthCubit, AuthState>(
          builder: (context, authState) {
            if (authState is AuthAuthenticated && 
              ...
              return BlocProvider(
                create: (context) => CartCubit(DependencyInjection.cartRepository, authState.userId)..loadCart(),
