...
class ProductController {
  ProductModel getProductDetails(String productId) {
    return ProductModel(
      ...
      description: "Crispy, sweet and freshly harvested organic apples from our farm",
      rating: 4.4,
      reviews: 156,
      price: 299,
      currency: "\$",
      ...
      isOrganic: true,
      storageInstructions: "Keep in cool, dry place. Refrigerate for longer freshness.",
      category: "Fruits",
      weights: [
